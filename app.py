...
st.set_page_config(
    page_title="Data Toolkit — Excel & PostgreSQL Utility",
...
st.title("📈 Data Toolkit — Excel & PostgreSQL Utility Dashboard")

if menu == "📅 Upload & Map":
    st.header("📅 Upload Excel/CSV & Map to PostgreSQL")
...
elif menu == "🔗 Link Files":
    link.link_files()

elif menu == "📊 Analyze Sheets":
    analyze_app()
